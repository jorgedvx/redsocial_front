...
export const UserList = ({ users, getUser, following, setFollowing, page, setPage, more, loading }) => {
                            ...
                            <div className="post__container">
                                ...
                                <div className="post__image-user">
                                    <Link to={"/social/perfil/" + user._id} className="post__image-link">
                                        {user.image != "default.png" && <img src={user.secure_url} className="post__user-image" alt="Foto de perfil UserList" />}
                                ...
                                <div className="post__body">
                                    ...
                                    <div className="post__user-info">
                                        ...
                                        <a href="#" className="user-info__create-date"><ReactTimeAgo date={Date.parse(user.created_at)} locale='es-ES'/></a>
                                    </div>
